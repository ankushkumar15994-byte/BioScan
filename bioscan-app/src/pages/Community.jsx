    ...
    const fetchCommunityData = async () => {
      try {
        const [statsRes, scansRes, contribRes] = await Promise.all([
          fetch('http://localhost:8000/api/community/stats'),
          fetch('http://localhost:8000/api/community/recent-scans'),
          fetch('http://localhost:8000/api/community/top-contributors')
        ]);
